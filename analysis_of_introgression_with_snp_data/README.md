...
<details>
  ...
  tree_sequence = simulate.simulate_to_vcf("chr1_no_geneflow.vcf", samples, population_configurations, sorted_events, 1e-8, 1e-8, 20000000, sample_names=sample_names, chrom_id="chr1")
  ```
</details>
