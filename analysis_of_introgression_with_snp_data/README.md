...
<img style="float: left;" src="img/simulated_tree_with_geneflow.png" width="200"> To remind ourselves, the simulated tree and geneflow events are shown on the left. The 15% f4-ratios estimates correspond reasonably well with the strength of the five geneflow events that we simulated (in the region of 8% to 18%).   
