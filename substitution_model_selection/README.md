...
<p align="center"><img src="img/paup9.png" alt="PAUP*" width="600"></p>(on the command line, use `autoPartition partition=CodonPositions method=allSchemes criterion=AIC modelset=j3 verbose=yes showSchemes=yes` instead).
